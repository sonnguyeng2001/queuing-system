...
export const AddServices = () => {
   ...
   const handleClickSubmit = () => {
      ...
      const inputDescDevices = document.getElementById(
         'inputDescDevices',
      ) as HTMLTextAreaElement | null;
      alert(
         `ID: ${inputID?.value} - ${inputNameDevices?.value} - ${inputDescDevices?.value}`,
      );
   };
   return (
         ...
         <div className={cx('content')}>
            ...
            <div className={cx('double-object')}>
               <div className={cx('object')}>
                  ...
                  <input id="inputID" className={cx('input-field')} type="text" />
                  <br />
